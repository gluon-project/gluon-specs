...
![pic](./flows/a-glu-to-thx-b.png)

### Alice uses ETH to send THX to Bob
![pic](./flows/a-eth-to-thx-b.png)

### Alice uses USD to send THX tokens to Bob
![pic](./flows/a-usd-to-thx-b.png)
